function getMessages(){
  // 1. Elle doit créer une requête AJAX pour se connecter au serveur, et notamment au fichier shootbox.php
  const requeteAjax = new XMLHttpRequest();
  requeteAjax.open("GET", "/wimf/code/script/shootbox.php");
...
function postMessage(event){
  ...
  const requeteAjax = new XMLHttpRequest();
  requeteAjax.open('POST', '/wimf/code/script/shootbox.php?task=write');
